...
var fish_database: Array = [
	...
	{"id":"fish_02","name":"Ikan Stage 1B","stage":1,"base_value":12,"rare":true,"collected":false,"sprite_path":"res://sprite/ikan_kecil11.png"},
...
func get_collection_percent() -> float:
	...
	return float(get_collected_count()) / float(fish_database.size()) * 100.0
